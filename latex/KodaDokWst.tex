...
% \label{subsec:kodowanie_predykcyjne}

% Kodowanie predykcyjne pozwala zredukować rozmiar danych dzięki wykorzystaniu wiedzy o~już przetworzonej części informacji. Dzięki temu możliwe jest użycie wielu rozkładów prawdopodobieństwa/przekształceń w taki sposób, by kodowany aktualnie symbol miał wysokie prawdopodobieństwo wystąpienia w~aktualnie używanym rozkładzie, a~co za tym idzie~---~możliwie niewielką długość słowa kodowego. By zakodowane dane były użyteczne, informacja o~używanych rozkładach musi być znana zarówno koderowi, jak i~dekoderowi. 
